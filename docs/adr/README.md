...
| # | Title | Status |
|---|-------|--------|
| [001](001-fully-local-architecture.md) | Fully Local Architecture (No Cloud APIs) | Accepted |
| [002](002-audio-routing-blackhole.md) | Audio Routing via BlackHole Virtual Audio Devices | Accepted |
